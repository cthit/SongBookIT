...
import FavoriteStar from "../../../use-cases/browse-songs/components/favorite-star";
...
const SongPreview = ({
    ...
    return (
        <SongCard>
            <DigitDesign.Link to={songBaseUrl + song.song_id}>
                <DigitDesign.CardBody justifyContent={"space-between"}>
                    <>
                        <DigitLayout.Row justifyContent={"space-between"}>
                            ...
                            {user && <FavoriteStar favorite={song.favorite} />}
                        </DigitLayout.Row>
                        <DigitText.Text
                            bold
